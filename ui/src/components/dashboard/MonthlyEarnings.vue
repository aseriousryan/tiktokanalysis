...
import type { ThumbUpIcon } from 'vue-tabler-icons';
    ...
    <v-card elevation="10" class="withbg">
        <v-card-item>
            <div class="d-flex align-center justify-space-between pt-sm-2">
                <v-card-title class="text-h5">Daily Likes</v-card-title>
            ...
            <v-row>
                <v-col cols="12">
                    <div class="mt-2">
                        <h3 class="text-h3">40</h3>
                        <div class="mt-1">
                            <v-avatar class="bg-lighterror text-accent" size="25">
                                <ArrowDownRightIcon size="20" />
                            </v-avatar>
                            <span class="text-subtitle-1 ml-2 font-weight-bold">-4%</span>
                            <span class="text-subtitle-1 text-muted ml-2">yesterday</span>
                        </div>
                    </div>
                </v-col>
            </v-row>
